package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !true ? var_122[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_675))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_675,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_90 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_675,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_454.parse(param1))
         {
            ...
            if(false)
            {
               var_122["null"] = var_454;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1279,var_454));
            var_454 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_47 != null && var_122 != null && param1 < var_47.length)
         {
            _loc2_ = var_47[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_47.splice(param1,1);
               delete var_122[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
