package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_789:int = 2;
      ...
      private var var_512:IRoomObjectFactory = null;
      
      private var var_1478:int;
      
      private var var_2380:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_513 = [];
         var_469 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_292,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_385,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_722,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_35 == const_1213)
         {
            if(var_896 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_512.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_512 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_512 != null)
         {
            return var_512.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_512.createRoomObjectLogic(_loc18_);
