package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         if(param1 != var_1246 || param2 != var_1662)
         {
            var_1246 = param1;
            var_1662 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_248 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_248.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_248.x = Math.round(var_248.x);
            var_248.y = Math.round(var_248.y);
         }
         return var_248;
      }
