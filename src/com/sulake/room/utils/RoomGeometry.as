package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_639:Number = 64;
      
      public static const const_1001:Number = 32;
      ...
      private var var_2346:Number = 500;
      ...
      private var var_2347:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_85 = new Vector3d();
         var_1042 = new Vector3d();
         var_1532 = 1;
         var_1533 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1534 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(var_232 == null)
         {
            var_232 = new Vector3d();
         }
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_232.assign(param1);
         if(var_232.x != _loc2_ || var_232.y != _loc3_ || var_232.z != _loc4_)
         {
            ++var_79;
         }
      ...
      {
         if(var_420 != param1 * var_1534)
         {
            var_420 = param1 * var_1534;
            ++var_79;
         }
      }
      ...
      {
         if(var_422 != param1 * var_1532)
         {
            var_422 = param1 * var_1532;
            ++var_79;
         }
      }
      ...
      {
         if(var_419 != param1 * var_1533)
         {
            var_419 = param1 * var_1533;
            ++var_79;
         }
      }
      ...
      {
         return new Vector3d(var_232.x,var_232.y,var_232.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1042.assign(_loc22_);
         }
         else
         {
            var_1042.assign(_loc17_);
         }
         ++var_79;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_419;
         _loc2_.z *= var_420;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1042);
         if(_loc3_ < var_2347 || _loc3_ > var_2346)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_419;
            _loc2_.z *= var_420;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1042);
         }
      ...
      {
         return new Vector3d(0 * var_422,0 * var_419,0 * var_420);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_422,0 * var_419,0 * var_420);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_422,param2.y * var_419,param2.z * var_420);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_422,param3.y * var_419,param3.z * var_420);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_422,param4.y * var_419,param4.z * var_420);
