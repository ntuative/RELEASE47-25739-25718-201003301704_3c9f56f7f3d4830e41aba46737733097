package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_305:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_496 = new Timer(const_1088,1);
      ...
      {
         return var_13.getSubCategoryViewId() == InventorySubCategory.const_274;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_411.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_411.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_526)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_695 == null)
         {
            var_695 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_695.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_274:
               ...
               break;
            case InventorySubCategory.const_875:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_13.checkCategoryInitilization(InventoryCategory.const_361);
         ...
         if(param1 == InventoryCategory.const_74 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_305:
                  var_13.toggleInventoryPage(InventoryCategory.const_144);
            }
         }
      }
      ...
      {
         if(var_858 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_13.showView();
            var_858 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_300 || _loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_281)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_411 = new Map();
         var_411.add(const_42,new Array());
         var_411.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
