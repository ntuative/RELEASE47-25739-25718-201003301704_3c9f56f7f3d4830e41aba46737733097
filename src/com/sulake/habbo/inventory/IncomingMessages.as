package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_10 = param1;
         var_26 = var_10.communication;
         var_26.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_26.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_26.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_26.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_26.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_26.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_26.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_26.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_26.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_26.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_26.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_26.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_26.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_26.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_26.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_26.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_26.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_26.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_26.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_26.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_26.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_26.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_26.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_26.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_26.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_26.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_26.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_26.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_26.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_26.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_26.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_26.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_26.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_26.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_26.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_26.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_26.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_26.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_637);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_26.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_144);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_326);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_10.toggleInventorySubPage(InventorySubCategory.const_274);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_10.setInventoryCategoryInit(InventoryCategory.const_237);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_361);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
