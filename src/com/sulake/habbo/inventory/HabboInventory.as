package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_761:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_637));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_74));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1002));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1612);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_326));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_274:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_760.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_760.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_274));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_340 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_760.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_46.getValue(InventoryCategory.const_361) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_946 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_237));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_368,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_361,_loc3_);
         ...
         var_46.add(InventoryCategory.const_74,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_340);
         var_46.add(InventoryCategory.const_237,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_637,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_340);
         var_46.add(InventoryCategory.const_326,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_274,_loc8_);
