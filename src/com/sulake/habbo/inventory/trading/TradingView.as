package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_762:uint = 4284532064;
      
      private static const const_763:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_913)
            {
            ...
            var_352.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_355);
            var_352.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1524 == null)
         {
            var_1524 = createMinimizedWindow();
         }
         if(!var_2040)
         {
            return var_61;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_61)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_762) : uint(const_763);
            }
