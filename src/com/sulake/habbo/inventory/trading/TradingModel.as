package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1232:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_493 = false;
         var_687 = false;
         var_48.updateItemList(var_688);
         var_48.updateItemList(var_1226);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_48.alertPopup(TradingView.const_959);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_688)
            {
               var_493 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_687 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_688)
            {
               var_48.alertPopup(TradingView.const_817);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_35 + " NEW STATE: " + param1 + " OWN: " + var_493 + " OTHER: " + var_687);
         ...
         {
            case const_171:
               if(param1 == const_163 || param1 == const_194)
               {
                  var_35 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_595)
         {
            if(var_35 != const_171 && var_35 != const_194)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_171;
            var_10.toggleInventorySubPage(InventorySubCategory.const_875);
            var_595 = false;
         }
         var_48.setMinimized(false);
      }
