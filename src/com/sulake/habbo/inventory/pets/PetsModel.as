package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1206 && param1.type == RoomEngineObjectEvent.const_218)
         {
            var_13.showView();
            var_1206 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1206 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_35,RoomObjectTypeEnum.const_323,_loc3_.figure);
            var_13.closeView();
            return;
         }
      ...
      {
         if(var_1007.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
