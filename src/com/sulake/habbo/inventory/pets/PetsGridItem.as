package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_50:
               var_1082.setSelectedGridItem(this);
               var_916 = true;
               break;
            ...
            case WindowMouseEvent.const_29:
               ...
               {
                  var_916 = false;
                  var_1082.placePetToRoom(var_1204.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1636) : uint(const_1637);
      }
