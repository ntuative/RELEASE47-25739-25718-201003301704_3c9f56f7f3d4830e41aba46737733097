package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_996:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_92 = var_566.height;
         var_997 = param5;
         var_819 = param6;
         var_220 = Math.floor(var_997 / _thumbWidth);
         var_20 = new BitmapData(var_997,var_819);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_20.height < var_819)
         {
            _loc12_ = new BitmapData(var_20.width,var_819);
      ...
      private function getList() : Array
      {
         ...
         if(var_996 != null)
         {
            _loc1_ = var_996.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_20 = new BitmapData(Math.max(var_220 * _thumbWidth,var_997),Math.max(var_481 * var_92,var_819),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_220 && var_20.height < _loc3_.y * var_92)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_220 - 1),var_92);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_220 - 1),0,_thumbWidth,var_20.height);
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_220 - 1),0 - var_92);
