package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1033:String = "tile_cursor";
      ...
      private var var_246:IAdManager = null;
      
      private var var_536:NumberBank;
      ...
      private var var_643:RoomMessageHandler = null;
      
      private var var_642:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_292 = new Map();
         var_536 = new NumberBank(1000);
         var_953 = new Map();
         var_293 = new Map();
         var_64 = new RoomObjectEventHandler(this);
         var_643 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_64 != null)
         {
            ...
            {
               return var_64.deleteWallItem(var_109,var_108,param1);
            }
         }
         return false;
      }
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_578) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_701) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_514) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_142);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_30)
            {
               return var_64.modifyWallItemData(var_109,var_108,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_642 != null)
         {
            var_642.release(new IIDRoomRendererFactory());
            var_642 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_642.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_924;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_665);
         }
         if(_loc10_.geometry != null)
         {
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_818) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_976);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_535,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_697,var_109,var_108,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            return var_64.modifyRoomObject(var_109,var_108,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_684,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_726,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_66);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_64 != null)
         {
            var_64.handleRoomObjectEvent(param1,var_109,var_108);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_230,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_303,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_325,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_862,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_988,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_991,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_266,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      {
         if(var_28 == null || var_431 == null || var_41 == null || var_642 == null || _communication == null || _habboConfiguration == null || !var_1652)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_277,RoomObjectCategoryEnum.const_66);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1217,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_109,var_108));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1134);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1134);
         if(_loc1_ != null)
         {
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_222,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_369,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_234,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_561,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_106,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_482,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_458,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_350,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_455,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectMoveEvent.const_415,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_472,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_238,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_419,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_297,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_294,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_473,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_855,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_370,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_476,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_192;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_533) != 0)
         {
            return false;
         }
         if(var_64 != null)
         {
            return var_64.initializeRoomObjectInsert(var_109,var_108,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_452 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_700,0,0));
            _loc2_ = 0;
      ...
      public function method_12(param1:int, param2:int, param3:int) : void
      {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_266,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_30:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_230));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_387);
                     break;
                  case RoomObjectCategoryEnum.const_35:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_181);
               }
            }
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_532)
         {
            var_1652 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_230,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_303,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_325,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_924,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_266,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_246.events.addEventListener(AdEvent.const_390,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_545,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_642 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc11_:int = var_536.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_30:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_230,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_387,param8);
               break;
            case RoomObjectCategoryEnum.const_35:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_181,param2);
               break;
            case RoomObjectCategoryEnum.const_66:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_591,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_636,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_508,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_358,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_953.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_879,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_536.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_communication != null)
         {
            _connection = _communication.getHabboMainConnection(method_5);
            if(_connection != null)
            {
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1413 - _loc12_.width / 2;
               _loc11_.y = var_1412 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_453,var_109,var_108,-1,RoomObjectCategoryEnum.const_192));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_64 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_277,const_486);
                  var_64.handleRoomObjectEvent(_loc14_,var_109,var_108);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1134);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1413 - _loc6_.data.width / 2;
               _loc11_.y = var_1412 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_282,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_803,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_887,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1012,RoomObjectVariableEnum.const_282,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_532,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_64 != null)
         {
            var_64.cancelRoomObjectInsert(var_109,var_108);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_879);
               ...
               var_536.freeNumber(_loc10_ - 1);
               _loc13_ = var_953.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_109,var_108,const_277,RoomObjectCategoryEnum.const_66,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_533,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_908,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_277,const_486,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_533,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_665,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_578,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_514,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_977,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_684,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_726,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_358,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_226);
         ...
         _loc7_.createRoomObject(const_743,const_1033,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
