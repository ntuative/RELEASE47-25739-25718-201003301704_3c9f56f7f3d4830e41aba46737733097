   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_682:
                  _loc2_.setString(RoomObjectVariableEnum.const_591,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_684:
                  _loc2_.setString(RoomObjectVariableEnum.const_636,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_358:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_226)
                  {
                     _loc8_ = "null";
                  }
                  var_387.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_535:
                  _loc7_ = var_387.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_387.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_873,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_942,int(_loc5_.bgOnly));
            var_1314 = _color;
            var_1569 = var_1182;
            var_1058 = _loc11_;
            var_1568 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_836,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_518,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1234,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1235,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1155,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_139 || _loc13_ == RoomPlaneData.const_259)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_895)
         {
            ...
            {
               _loc7_ = var_1314 >> 16 & 255;
               _loc8_ = var_1314 >> 8 & 255;
               _loc9_ = var_1314 & 255;
               _loc10_ = var_1058 >> 16 & 255;
               _loc11_ = var_1058 >> 8 & 255;
               _loc12_ = var_1058 & 255;
               _loc13_ = (_loc2_ - var_895) / var_1567;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1569 + (var_1568 - var_1569) * _loc13_;
               _color = _loc3_;
               var_1182 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_518,_loc3_);
         }
      }
   }
}
