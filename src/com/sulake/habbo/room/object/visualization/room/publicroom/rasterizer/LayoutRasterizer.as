package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_966:LayoutRasterizerData = null;
      ...
      {
         var_460 = true;
         var _loc3_:int = var_330.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_330.push(param1);
            var_458.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_965 = param1;
         var _loc3_:LayoutRasterizerData = var_44.getValue(var_652);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1151 = RoomObjectVariableEnum.const_803;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1151 = RoomObjectVariableEnum.const_887;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1151);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1716);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_652)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_966 = var_44.getValue(var_652);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_44.getValue(var_652);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_966.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_330.indexOf(_loc10_) >= 0 && var_460)
            {
               param1 = var_330.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_853.getAsset(var_458[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
