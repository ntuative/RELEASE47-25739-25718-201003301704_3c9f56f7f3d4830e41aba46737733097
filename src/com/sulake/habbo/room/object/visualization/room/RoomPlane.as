package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_261:int = 1;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_261 || _type == const_184))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_864 || false && false && !var_154 || var_618 == null)
         {
            return;
         }
         ...
         if(var_154)
         {
            ...
            while(_loc5_ < var_194.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_618.updateMask(var_59,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_261 || _type == const_184)
         {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1205.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1205[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_700 != null)
            {
               _loc3_ = var_700.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1519,var_2027,var_2029,var_2030,var_2028,param2);
               if(_loc3_ != null)
               {
