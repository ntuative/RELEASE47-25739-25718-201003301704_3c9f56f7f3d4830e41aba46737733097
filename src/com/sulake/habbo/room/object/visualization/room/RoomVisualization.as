package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1058:int = 16777215;
      
      public static const const_1375:int = 10066329;
      
      private static const const_1059:int = 13421772;
      
      public static const const_1327:int = 16777215;
      
      private static const const_1407:int = 0;
      
      public static const const_1297:int = 16777215;
      
      private static const const_1060:int = 10066329;
      
      private static const const_1057:int = 10066329;
      
      public static const const_1332:int = 13421772;
      ...
      private var var_552:Rectangle = null;
      
      private var var_1800:int = 255;
      
      private var var_1803:Boolean = false;
      
      private var var_1801:int = 255;
      ...
      private var var_387:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_387 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_836);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_977);
         var _loc7_:int = 0;
         while(_loc7_ < var_76.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_261,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_259)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1297;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1332;
               }
               else
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_261 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_552 == null)
         {
            var_552 = super.boundingRectangle;
         }
         return new Rectangle(var_552.x,var_552.y,var_552.width,var_552.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_387.maskCount)
         {
            _loc6_ = var_387.getMaskType(_loc5_);
            _loc7_ = var_387.getMaskLocation(_loc5_);
            _loc8_ = var_387.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_104.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_261 || _loc3_.type == RoomPlane.const_184 && _loc8_ == RoomPlaneBitmapMaskData.const_226)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1446;
                        if(var_76.getPlaneType(_loc9_) == RoomPlaneData.const_138)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1246)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1033 || _loc9_.y != var_1798 || _loc9_.z != var_1796 || param1.scale != var_1797))
            {
               var_1033 = _loc9_.x;
               var_1798 = _loc9_.y;
               var_1796 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_873);
            if(_loc10_ != var_1804)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_518));
            if(_loc11_ != var_981)
            {
               var_981 = _loc11_;
               var_1801 = var_981 & 255;
               var_1800 = var_981 >> 8 & 255;
               var_1795 = var_981 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1802 + const_1622 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1802 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_636);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_591);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_508);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1799 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_942));
            var_161 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_388.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_388[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_184)
            {
               if(var_1799)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1801 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1800 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1795 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_104.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_261 && param2 != null)
               {
                  _loc5_.id = param2;
               }
