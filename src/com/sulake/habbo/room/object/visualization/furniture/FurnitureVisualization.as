package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1481:String = null;
      ...
      protected var var_2272:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1481 != null && var_1481.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2281,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2194 != param1 || var_2195 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2193 != param1 || var_2192 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2281 = _loc3_.getNumber(RoomObjectVariableEnum.const_230);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_207));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1481 = _loc3_.getString(RoomObjectVariableEnum.const_325);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_288 != _loc3_.getUpdateID() || param1 != var_208 || param2 != var_2272)
         {
