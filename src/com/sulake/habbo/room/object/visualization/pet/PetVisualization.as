package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_757:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_865);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_986)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_997);
               var_445 = const_1026;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_253);
         switch(_loc14_)
         {
         ...
         var _loc16_:Boolean = _isAnimating || var_445 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_581 != _loc7_)
            {
               for each(_loc36_ in var_412.getKeys())
               {
                  var_412.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_311);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_253);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_727);
            _loc6_.appendAction(AvatarAction.const_646,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_417);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_304,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_444) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1025;
            ...
            {
               _loc29_ = null;
               _loc29_ = var_757.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_758.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_758)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_757 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
