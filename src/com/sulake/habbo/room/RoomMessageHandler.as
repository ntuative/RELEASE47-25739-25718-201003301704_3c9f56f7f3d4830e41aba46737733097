package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1015:int = -1000000000;
      ...
      private function onObjectRemove(param1:IMessageEvent) : void
      {
         ...
         var_9.method_6(_loc4_,_loc5_,_loc6_);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_856,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_665);
         var _loc8_:int = 0;
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.webID == var_1907)
               {
                  var_9.method_12(_loc4_,_loc5_,_loc7_.id);
               }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_900:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1007:
                     _loc10_ = "std";
               }
