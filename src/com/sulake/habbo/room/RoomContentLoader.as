package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_280:String = "RCL_PUBLICROOM_";
      ...
      private static const const_1099:String = const_345;
      ...
      public static const const_532:String = "RCL_LOADER_READY";
      ...
      private var var_1040:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_506 = [];
         var_507 = [];
         var_2068 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2067 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_418 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_292,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_131 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_416 != null)
         {
            _loc2_ = var_416.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_280 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_175 != null && var_175.hasWorldType(const_280 + param1))
         {
            return var_175.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_505.add(_loc10_,_loc11_);
                              if(var_506.indexOf(_loc14_) < 0)
                              {
                                 var_506.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_418 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_418.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_356 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_356.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_418.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_589.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_418.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_345,const_493,ROOM_CONTENT,const_769,const_768];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2068.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_162 && _loc5_ != RoomObjectLogicEnum.const_131)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_505.getValue(param1) as String;
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_175 != null && (var_175.type == param1 || var_175.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1099;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1173);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2067.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_292,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_385,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_2070)
         {
            ...
            if(var_1040 != null)
            {
               var_1040.dispatchEvent(new Event(const_532));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_175 != null)
         {
            return var_175.getWorldHeightScale(const_280 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1040 = param1;
            var_2071 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2065 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2069 = param2.getKey("public.room.dynamic.download.url","");
            var_2066 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_35 = const_767;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_356.getValue(_loc2_) as IGraphicAssetCollection;
      }
      
      private function method_8(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = getContentType(param1);
         if(false)
         {
            _loc3_ = var_356.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_416 != null)
         {
            var_416.remove(param2);
            var_416.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_162 && _loc5_ != RoomObjectVisualizationEnum.const_131)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_280 + param1) == RoomObjectCategoryEnum.const_66)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_175 = var_1267.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_175 != null)
         {
            return var_175.getWorldScale(const_280 + param1);
         }
         return 32;
      }
