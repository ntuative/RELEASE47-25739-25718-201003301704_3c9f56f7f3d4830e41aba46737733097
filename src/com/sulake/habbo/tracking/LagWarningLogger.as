package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1339 || var_1548 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1547 == 0 || _loc1_ - var_1547 > var_1548)
         {
            if(_connection != null)
            {
      ...
      {
         var_1339 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1548 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
