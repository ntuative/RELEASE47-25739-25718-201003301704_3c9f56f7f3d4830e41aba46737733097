package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_213:LatencyTracker = null;
      
      private var var_214:PerformanceTracker = null;
      ...
      private var var_769:LagWarningLogger = null;
      
      private var var_770:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_214 = new PerformanceTracker();
         var_213 = new LatencyTracker();
         var_769 = new LagWarningLogger();
         var_1131 = new Array(const_741);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1206,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1196,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_717,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_921,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1339);
               break;
            case HabboCommunicationEvent.const_613:
               trackLoginStep(HabboLoginTrackingStep.const_1266,String(_communication.port));
               break;
      ...
      private function method_5(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_214 != null)
            {
               var_214.connection = param1;
            }
            if(var_213 != null)
            {
               var_213.communication = _communication;
               var_213.connection = param1;
            }
            if(var_769 != null)
            {
               var_769.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_299:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_147)
         {
            Component(var_147).events.addEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
            if(var_213 != null)
            {
               var_213.configuration = var_147;
            }
            if(var_214 != null)
            {
               var_214.configuration = var_147;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_246.events.addEventListener(AdEvent.const_390,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1644)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1149);
            var_1644 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_921,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_717,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_613,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_394,onHotelViewEvent);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_770)
            {
               var_770.release(new IIDHabboWindowManager());
               var_770 = null;
            }
            if(var_246)
            {
            ...
            if(var_163)
            {
               if(true)
               {
                  ...
                  Component(var_163).events.removeEventListener(HabboFriendListTrackingEvent.const_299,onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_147)
         {
            if(var_769 != null)
            {
               var_769.configure(var_147);
            }
            Component(var_147).events.removeEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_820);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_820,onCoreRunning);
         }
      }
      ...
      {
         var_770 = IHabboWindowManager(param2);
         if(var_770)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_952 > -1 && _loc2_ < var_952)
         {
            ++var_1409;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1409);
         }
         if(var_952 > -1 && _loc2_ - var_952 > 15000)
         {
            ++var_1410;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1410);
         }
         var_952 = _loc2_;
         if(var_214 != null)
         {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_163).events.addEventListener(HabboFriendListTrackingEvent.const_299,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_147)
            {
               if(var_147.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_214 != null)
                  {
                     _loc4_["null"] = var_214.flashVersion;
                     _loc4_["null"] = var_214.averageUpdateInterval;
                  }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_394)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1150);
         }
         else if(param1.type == HabboHotelViewEvent.const_62)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1323);
         }
      }
   }
}
