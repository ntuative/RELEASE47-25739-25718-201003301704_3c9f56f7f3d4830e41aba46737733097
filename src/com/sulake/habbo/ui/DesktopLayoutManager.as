package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1635:String = "room_widget";
      
      private const const_1093:String = "room_view";
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_54.getChildByTag(const_1093) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_54.findChildByTag(const_1093) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_703;
               _loc2_.width = var_54.desktop.width - var_703;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_703;
               _loc2_.height = var_54.desktop.height - var_703;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_54.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1635) == 0)
            {
