package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFriendRequestMessage.const_515);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_521);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_124:
            ...
            case FriendRequestEvent.const_269:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_725:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_515:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_521:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_124);
         _loc1_.push(FriendRequestEvent.const_54);
         _loc1_.push(FriendRequestEvent.const_269);
         return _loc1_;
      }
