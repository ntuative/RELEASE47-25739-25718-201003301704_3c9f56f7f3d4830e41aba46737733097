package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_489:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_141];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_141:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_680.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_323:
      ...
      {
         return [RoomWidgetChatMessage.const_606,RoomWidgetChatSelectAvatarMessage.const_732];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_606:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_141,_container.roomSession,0,"Version 25739-25718-201003301629");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_732:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_833 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_833);
            }
            if(var_489 == null)
            {
               var_488.x = 0;
               var_488.y = 0;
               var_488.z = 0;
               var_489 = _loc4_.getScreenPoint(var_488);
               var_833 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_488.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_489.x || _loc8_.y != var_489.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_489,_loc5_));
