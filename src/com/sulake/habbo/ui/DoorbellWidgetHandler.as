package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_516];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_516:
      ...
      {
         return [RoomSessionDoorbellEvent.const_100,RoomSessionDoorbellEvent.const_116,RoomSessionDoorbellEvent.const_54];
      }
