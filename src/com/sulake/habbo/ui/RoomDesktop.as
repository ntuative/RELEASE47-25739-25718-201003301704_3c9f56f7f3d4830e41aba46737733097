package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_560:IAvatarRenderManager = null;
      ...
      private var var_340:ISessionDataManager = null;
      
      private var var_2082:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_292,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_385,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_722,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_712 = _roomEngine.loadRoomResources(var_40.roomResources);
            if(false)
            {
               var_1273 = false;
         ...
         {
            var_1272 = !var_246.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_40.roomId,var_40.roomCategory,var_276[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_269,processEvent);
         }
         _friendList = null;
         var_177.dispose();
         var_177 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_292,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_385,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_722,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_768 = null;
         ...
         if(var_198 && false)
         {
            var_198.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_198.events.removeEventListener(HabboToolbarEvent.const_58,onHabboToolbarEvent);
         }
         var_198 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2082);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_198 != null)
         {
            var_177.toolbarSize = var_198.size;
            var_177.toolbarOrientation = var_198.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_632:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_291,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_641 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_40.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_477)
                  {
                     var_641.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_704,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_40.roomId,var_40.roomCategory,RoomVariableEnum.const_651);
            _loc13_ = _roomEngine.getRoomNumberValue(var_40.roomId,var_40.roomCategory,RoomVariableEnum.const_701);
            _loc14_ = _roomEngine.getRoomNumberValue(var_40.roomId,var_40.roomCategory,RoomVariableEnum.const_578);
            _loc15_ = _roomEngine.getRoomNumberValue(var_40.roomId,var_40.roomCategory,RoomVariableEnum.const_514);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_40 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_475:
               ...
               var_176 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_333,WindowStyle.const_319,WindowParam.const_89) as IToolTipWindow;
               var_176.setParamFlag(WindowParam.const_49,false);
      ...
      {
         if(var_712 == null || false)
         {
            return;
         }
         var _loc2_:int = var_712.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_712.splice(_loc2_,1);
         }
         if(false)
         {
            var_1273 = true;
      ...
      {
         if(var_19 != null && var_40 != null && var_1272 && var_1273)
         {
            var_19.startSession(var_40);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_247));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_269,processEvent);
         }
      }
