package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1102:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_559,RoomWidgetPresentOpenMessage.const_576,RoomWidgetPresentOpenedMessage.const_1358];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_82:
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1102)
                              {
                                 break;
                              }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_559:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_146 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_142);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
