package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_158,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_158,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_988);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_991);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_323)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_477)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_863)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_736);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_200)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_499);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1352;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_912;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1171);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_569.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_53);
            var_569.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_499);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_673);
         _loc1_.push(RoomWidgetFurniActionMessage.const_541);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_625);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_674);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1168);
         _loc1_.push(RoomWidgetPetCommandMessage.const_546);
         _loc1_.push(RoomWidgetPetCommandMessage.const_525);
         _loc1_.push(RoomWidgetUserActionMessage.const_709);
         _loc1_.push(RoomWidgetUserActionMessage.const_357);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_569 != null)
         {
            _loc1_ = var_569.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_569.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_411)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_658:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_868,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_513:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_673:
            ...
            case RoomWidgetRoomTagSearchMessage.const_625:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_674:
            ...
            case RoomWidgetUserActionMessage.const_712:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_525:
