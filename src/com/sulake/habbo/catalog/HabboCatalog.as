package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_394:ICatalogNavigator;
      ...
      private var var_1851:GiftWrappingConfiguration;
      ...
      private var var_993:ClubGiftController;
      ...
      {
         return var_340.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1852 && var_477 != null)
         {
            var_477.playSound(HabboSoundTypesEnum.const_857);
         }
         var_1852 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_340.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = var_340.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_91:
               var_1190 = param1.session.isPrivateRoom;
               if(var_86 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1851 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_993.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_394 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_993 == null)
         {
            var_993 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_394.buildCatalogIndex(_loc2_);
         if(var_992 != "")
         {
            var_394.openPage(var_992);
            var_992 = "";
         }
         else
         {
            var_394.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1850 && var_477 != null)
         {
            var_477.playSound(HabboSoundTypesEnum.const_950);
         }
         var_1850 = false;
      }
