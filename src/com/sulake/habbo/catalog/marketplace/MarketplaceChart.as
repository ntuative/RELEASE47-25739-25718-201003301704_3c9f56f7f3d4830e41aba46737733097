package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1030 + var_1030 / -var_2345 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_857 - var_857 / var_409 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_409).toString().length - 1);
         var_409 = Math.ceil(var_409 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_409.toString();
         _loc3_.draw(_loc6_);
         var_1030 = param1 - _loc6_.textWidth - 2;
         var_857 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_857);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_857 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1030 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1030,(param2 - var_857) / 2));
         return _loc3_;
      }
