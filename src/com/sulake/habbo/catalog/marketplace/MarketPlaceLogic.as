package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2253:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1498,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1929 || param1.furniTypeId != var_1924)
         {
            return;
         }
         var_2253 = param1;
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_356)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1719 = _loc3_.creditsWaiting;
         var_205 = new Map();
      ...
      {
         requestOffers(var_2254,var_2252,var_1766,var_2251);
      }
