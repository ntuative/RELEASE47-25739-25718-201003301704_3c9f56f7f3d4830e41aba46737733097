package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1419:XML;
      ...
      private var var_1420:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1419 == null)
         {
            ...
            var_1419 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1420 == 4294967295)
            {
               var_1420 = _loc1_.color;
            }
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1419) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1268;
            }
         }
      }
