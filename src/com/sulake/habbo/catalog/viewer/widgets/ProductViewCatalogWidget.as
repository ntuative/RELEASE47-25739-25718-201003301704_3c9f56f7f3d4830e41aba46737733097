package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1122:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         else
         {
            ...
            {
               case Offer.const_450:
                  _loc4_ = var_1123.clone();
                  if(var_534 != null)
                  {
                     var_534.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_534,var_1122,var_1382);
                  }
                  break;
                     ...
                     case ProductTypeEnum.include:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_304,AvatarAction.const_719);
                              _loc13_.appendAction(AvatarAction.const_730,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1393 = new Point(var_81.x,var_81.y);
         var_534 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1122 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_534 == null)
         {
         ...
         var_1123 = _loc2_.content as BitmapData;
