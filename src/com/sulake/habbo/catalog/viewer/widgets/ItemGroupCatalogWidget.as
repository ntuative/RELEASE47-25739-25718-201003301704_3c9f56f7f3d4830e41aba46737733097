package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_597[var_1052] as Array;
      ...
      {
         var _loc2_:Offer = var_597[var_1052][var_2111];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_383 || _loc1_.pricingModel == Offer.const_391)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_78)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1051.indexOf(_loc5_) == -1)
                        {
                           var_1051.push(_loc5_);
                           var_597.push(new Array());
                        }
                        _loc6_ = var_1051.indexOf(_loc5_);
                        (var_597[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_597)
         {
            if(var_2111 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2111] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1052 = var_931.getGridItemIndex(param1.view);
