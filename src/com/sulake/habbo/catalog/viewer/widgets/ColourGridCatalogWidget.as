package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1192 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_305 = null;
         for each(_loc1_ in var_1193)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1192) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_670.width,var_670.height,true,0);
               _loc3_.bitmap.copyPixels(var_670,var_670.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_713.width,var_713.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_713,var_713.rect,new Point(0,0),null,null,true);
