package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1633:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_486)
         {
            ...
            var_486 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_486)
         {
            return;
         ...
         if(!var_404)
         {
            var_404 = new Timer(25);
            var_404.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_830 = 0;
         populateList();
         var_404.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_535)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_486 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_486.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_403.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_404)
         {
            var_404.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_404 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_830 >= var_535.length)
            {
               return true;
            }
            addListItem(var_535.getWithIndex(var_830));
            ++var_830;
            _loc1_++;
         }
         return false;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_403));
            _loc7_.selection = 0;
         }
      }
