package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1220:String = "default";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_275 != null && var_274 != null)
         {
            setRoomImage(var_275,var_274);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_147.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_273];
               if(_loc11_ != null)
               {
         ...
         switch(param1)
         {
            case const_182:
               ...
               for each(_loc8_ in var_147.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_705 = _loc8_.children().length();
                  }
               }
            ...
            case const_183:
               ...
               if(var_310 >= _activeFloorPatterns.length)
               {
                  var_310 = 0;
               }
               var_273 = 0;
               ...
               for each(_loc9_ in var_147.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_704 = _loc9_.children().length();
                  }
               }
            ...
            case const_184:
               ...
               for each(_loc10_ in var_147.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_706 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1220);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1220,var_1219,64,this,"window_romantic_wide");
