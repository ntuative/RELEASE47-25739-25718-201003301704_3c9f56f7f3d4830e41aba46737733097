package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_945 != null)
         {
            var_945.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_944 != null)
         {
            var_944.removeEventListener(WindowKeyboardEvent.const_153,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_945 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_945 != null)
         {
            var_945.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_944 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_944 != null)
         {
            var_944.addEventListener(WindowKeyboardEvent.const_153,windowKeyEventProcessor);
         }
      }
