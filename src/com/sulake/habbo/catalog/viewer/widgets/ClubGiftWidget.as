package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_535.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_182)
         {
            var_182 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_182)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_182.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_182.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      {
         if(!param1 || !param2 || !var_535 || !var_13)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_535.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
