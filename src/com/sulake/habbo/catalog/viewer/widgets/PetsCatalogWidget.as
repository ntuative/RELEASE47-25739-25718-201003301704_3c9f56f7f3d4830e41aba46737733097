package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_413 >= var_307.length)
         {
            return "";
         }
         var petColor:IPetColor = var_307[var_413] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_579[var_1522] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_413 = param1.index;
         if(var_413 < 0 || var_413 > var_307.length)
         {
            var_413 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_535.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_868 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_307 = [];
         var_579 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_868);
               if(_loc11_)
               {
                  var_579 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_579.length)
         {
            _loc12_ = var_579[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_868,_loc12_.id),getRaceLocalizationKey(var_868,_loc12_.id)));
            _loc6_++;
         }
         var_535.add(var_868,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_899,onApproveNameResult);
         _loc5_ = var_535.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_535.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_413 >= 0 && var_413 < var_307.length)
         {
            _loc7_ = var_307[var_413] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_579[var_1522] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_868,_loc3_.id,_loc2_,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_304,AvatarAction.const_592);
