package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1456:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_563 != null)
         {
            if(var_563.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_563.window);
            var_563.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1456);
         var_563 = _loc5_;
      ...
      {
         return var_563.dispatchWidgetEvent(param1);
      }
