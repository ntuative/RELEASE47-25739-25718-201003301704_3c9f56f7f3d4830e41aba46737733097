package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1340:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_859:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_900);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1141) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1340;
            _loc2_.init();
         }
         var_1340.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1340.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_900);
      }
