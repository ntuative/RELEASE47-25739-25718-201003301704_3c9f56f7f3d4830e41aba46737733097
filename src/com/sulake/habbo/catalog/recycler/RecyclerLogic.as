package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_780:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1579)
         {
            case RecyclerStatusMessageEvent.const_1368:
               ...
               break;
            case RecyclerStatusMessageEvent.const_895:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1579 != RecyclerStatusMessageEvent.const_895;
      }
      
      private function get statusActive() : Boolean
      {
         return var_281 != const_780;
      }
      ...
      {
         return active && var_281 == const_349;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_826:
               if(_view != null)
               {
