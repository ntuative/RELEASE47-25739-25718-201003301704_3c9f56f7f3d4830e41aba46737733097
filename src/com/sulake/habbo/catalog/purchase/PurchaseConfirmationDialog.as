package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1423:uint = 4.294967295E9;
      
      private const const_1422:uint = 4.293848814E9;
      
      private var var_912:int;
      
      private const const_1640:uint = 4.291613146E9;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_735:
               showSelectors(false);
               break;
            case WindowEvent.const_622:
               showSelectors(true);
         }
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_911;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_911,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1422) : uint(const_1423);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_563,var_75,var_1076);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_911);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_614[var_204]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_613[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_563,var_75,var_1076,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_50:
               ...
               break;
            case WindowKeyboardEvent.const_510:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_613 = _loc1_.ribbonTypes;
            var_911 = var_1390[0];
            var_204 = var_614[0];
            _ribbonIndex = var_613[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_523 == null)
         {
            var_523 = createWindow("suggestion_list_item") as IWindowContainer;
            var_523.procedure = suggestionsEventHandler;
         }
         if(var_238 == null || var_523 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_238.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_523.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
