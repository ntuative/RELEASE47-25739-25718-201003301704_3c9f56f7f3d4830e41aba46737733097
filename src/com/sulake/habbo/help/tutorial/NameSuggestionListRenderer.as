package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1620:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_794 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_794 += param1.height + const_1621;
            return fit(param1);
         }
         param1.offset(_offsetX,var_794);
         _offsetX += param1.width + const_1620;
         return true;
      }
