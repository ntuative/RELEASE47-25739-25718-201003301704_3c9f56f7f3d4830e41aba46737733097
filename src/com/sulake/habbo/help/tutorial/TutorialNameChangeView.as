package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1507:uint = 13232628;
      ...
      private var var_266:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_407);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_407);
         }
         if(var_266 == null)
         {
            var_266 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_266 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_266);
            var_266.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_266.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1596 || param1 == ChangeUserNameResultMessageEvent.var_1594)
         {
