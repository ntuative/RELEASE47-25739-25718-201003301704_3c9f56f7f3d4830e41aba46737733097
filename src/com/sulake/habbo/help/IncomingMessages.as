package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_24.tellUI(HabboHelpViewEnum.const_221,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_267,_loc6_);
      }
      ...
      {
         var_24.showUI(HabboHelpViewEnum.const_287);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_442);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_534);
         var_24.tellUI(HabboHelpViewEnum.const_534,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_477)
            {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_519);
      }
