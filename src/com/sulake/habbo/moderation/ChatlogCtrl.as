package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1469:IMessageComposer;
      ...
      {
         var_855 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_856 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1469);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_855.clone());
      ...
      {
         if(param1.type != WindowEvent.const_44 || param2 != var_52)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_856.clone());
         _loc4_.color = var_1239[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
