package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1395:IIssueBrowserView;
      ...
      private var var_1397:IIssueBrowserView;
      
      private const const_1643:String = "closed_issues";
      ...
      private var var_1396:PickedIssuesView;
      
      private var var_327:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_327.view.width = var_210.container.width;
         var_327.view.height = var_210.container.height;
         var_327.visible = true;
         var_327.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1615:
               if(var_1397 == null)
               {
                  var_1397 = new MyIssuesView(issueManager,this,var_210.container);
               }
               return var_1397;
            case const_1613:
               if(var_1395 == null)
               {
                  var_1395 = new OpenIssuesView(issueManager,this,var_210.container);
               }
               return var_1395;
            case const_1614:
               if(var_1396 == null)
               {
                  var_1396 = new PickedIssuesView(issueManager,this,var_210.container);
               }
               return var_1396;
            default:
               return null;
