package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_563:String = "issue_bundle_my";
      
      public static const const_848:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_142 = new Map();
         var_915 = new Map();
         var_615 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_743 = [];
         var_914 = [];
         var_1077 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1077.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_142)
         {
            switch(param1)
            {
               case const_972:
                  ...
                  break;
               case const_563:
                  if(_loc4_.state == IssueMessageData.const_437 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_743 = var_743.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_915.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_915.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1369)
         {
            var_153.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_142)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_915.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_915.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_146)
         {
            ...
            _loc8_ = var_914.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_437 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1077.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_615 == null || !var_615.isOpen())
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_982);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_915.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_142.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_437 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
