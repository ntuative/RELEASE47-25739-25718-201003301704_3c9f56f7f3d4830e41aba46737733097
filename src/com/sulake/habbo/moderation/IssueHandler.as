package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_390:UserInfoCtrl;
      
      private var var_57:ModerationManager;
      
      private var var_985:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_390 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_985 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_390.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_111.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_985.load(_loc4_,var_111.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_57.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_57,WindowTracker.const_891,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_390 = new UserInfoCtrl(_window,var_57,_loc3_.message);
            var_390.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
