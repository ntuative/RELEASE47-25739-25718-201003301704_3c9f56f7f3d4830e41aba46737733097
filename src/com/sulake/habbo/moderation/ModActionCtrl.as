package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_633:OffenceCategoryData;
      ...
      private var var_632:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_764 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_763 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_762.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1121,var_375.text,getBanLength(),var_1120));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_762.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1121,var_375.text,var_1120));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_633 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1121,var_375.text,var_1120));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_633 != null;
         if(this.var_632 != null)
         {
            var_52.findChildByName("offence_txt").caption = this.var_632.name;
            var_52.findChildByName("offence_category").visible = true;
         }
         else if(this.var_633 != null)
         {
            this.refreshButtons("offences_cont",2,var_633.offences,var_764,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_763,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_632 = var_633.offences[_loc3_];
         var_375.text = var_632.msg;
         var_306 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_52.caption = "Mod action on: " + var_1392;
         ...
         var_375 = ITextFieldWindow(var_52.findChildByName("message_input"));
         var_375.procedure = onInputClick;
         var_762 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_762);
