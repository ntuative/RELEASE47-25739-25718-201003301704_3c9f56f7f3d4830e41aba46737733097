package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1164:
            ...
            case CantConnectMessageParser.const_1248:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1202:
      ...
      private function onCanCreateRoomEventEvent(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.method_1.startEventEdit();
         }
         else
         {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            setToolbarExitIcon();
            _navigator.method_1.open(false);
         }
      }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.enterRoom)
         {
            ...
            if(_loc4_)
            {
               _navigator.method_1.open(_loc3_);
            }
      ...
      private function onThumbnailUpdated(param1:IMessageEvent) : void
      {
         ...
         _navigator.method_1.backToRoomSettings();
         _navigator.send(new GetGuestRoomMessageComposer(_loc2_.flatId,false,false));
      }
