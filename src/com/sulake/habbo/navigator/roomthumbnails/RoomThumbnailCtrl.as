package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1501,this._model.mode != ThumbnailEditorModel.const_55);
         setEnabled(var_1502,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function onCancelButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.method_1.backToRoomSettings();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1501 = IButtonWindow(find("top_tab"));
         var_1502 = IButtonWindow(find("obj_tab"));
         var_1946 = IWindowContainer(find("tile_grid"));
         var_1947 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1501,onTopTabButton);
         Util.setProcDirectly(var_1502,onObjTabButton);
      }
      ...
      {
         this._navigator.method_1.reload();
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1946;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_405)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1947;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,param1.width,66)));
