package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1055:int = -16;
      
      private static const const_745:int = 32;
      
      private static const const_1056:int = 8;
      
      public static const const_405:int = 10;
      ...
      private var var_806:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_806 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_806.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1055,_loc4_.y + const_1054 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1765[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_806.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_806.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_806.getImage(ThumbnailEditorModel.const_55,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_745 / 2);
         return new Point(param1 * const_745 + _loc3_,param2 * const_1056);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1165 == null)
         {
            var_1165 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1165,var_1165.rect,new Point(0,0),null,null,true);
      }
   }
}
