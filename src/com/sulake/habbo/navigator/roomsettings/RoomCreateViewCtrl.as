package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_834:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"s"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"t"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"u"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"v"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"w"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_136,0,"x"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1023 = new TextFieldManager(_navigator,ITextFieldWindow(var_21.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1932 = _navigator.data.hcMember;
      }
      ...
      private function refresh() : void
      {
         ...
         var_834 = var_44[0];
         if(var_1932 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_834.view.findChildByName("select_arrow"));
