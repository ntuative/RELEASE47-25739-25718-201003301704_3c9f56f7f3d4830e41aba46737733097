package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_654.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_791.getText());
         addTag(_loc6_,var_792.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1427.visible = true;
         var_1721.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_654.setText(param1.eventDescription);
         var_791.setText(getTagFromEvent(param1,1));
         var_792.setText(getTagFromEvent(param1,2));
         var_1154.visible = false;
         var_1153.visible = true;
         var_1155.visible = true;
         var_1429.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1427 = IWindowContainer(find("event_type_disabled_cont"));
            var_1721 = ITextWindow(find("event_type_disabled_text"));
            var_1429 = ITextWindow(find("create_caption"));
            var_1428 = ITextWindow(find("edit_caption"));
            var_1154 = IButtonWindow(find("create_button"));
            var_1153 = IButtonWindow(find("edit_button"));
            var_1720 = IButtonWindow(find("cancel_button"));
            var_1155 = IButtonWindow(find("end_button"));
            var_790 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1154,onCreateButtonClick);
            Util.setProcDirectly(var_1153,onEditButtonClick);
            Util.setProcDirectly(var_1155,onEndButtonClick);
            Util.setProcDirectly(var_1720,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_654 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_791 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_792 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_654.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1427.visible = false;
         var_1154.visible = true;
         var_1153.visible = false;
         var_1155.visible = false;
         var_654.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_791.goBackToInitialState();
         var_792.goBackToInitialState();
         var_790.selection = 0;
         var_1429.visible = true;
