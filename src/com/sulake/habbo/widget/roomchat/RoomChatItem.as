package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      {
         _widget.onItemMouseOut(var_1000,var_999,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1000,var_671,var_999,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1201 = param1.chatType;
         var_1000 = param1.userId;
         var_671 = param1.userName;
         var_999 = param1.userCategory;
         _message = param1.text;
         var_1200 = param1.userX;
         var_187 = param1.userImage;
         var_998 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_187 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_396 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_998 != 0)
            {
               _loc30_ = uint(var_998 >> 16 & 255);
               _loc31_ = uint(var_998 >> 8 & 255);
               _loc32_ = uint(var_998 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1201 == RoomWidgetChatUpdateEvent.const_243)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_671);
            }
            else if(var_1201 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_671);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_341 + _loc20_.textWidth + const_488;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1000,var_999,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1000,var_999,_roomId,_roomCategory,param1);
      }
