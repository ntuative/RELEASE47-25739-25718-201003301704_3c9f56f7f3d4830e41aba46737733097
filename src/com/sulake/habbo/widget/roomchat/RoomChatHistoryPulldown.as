package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_764:int = 150;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_1525 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2053 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1526 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1527 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         ...
         var_72 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,param3.width,param3.height - const_73),null,0,0) as IBitmapWrapperWindow;
         var_39.addChild(var_72);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_59,HabboWindowStyle.const_38,HabboWindowParam.const_40,new Rectangle(0,0 - const_73,param3.width,const_73),null,0) as IWindowContainer;
         var_39.addChild(_window);
         var_96 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_430,HabboWindowStyle.const_41,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_73),null,0) as IRegionWindow;
         if(var_96 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_352:
               ...
               break;
            case const_760:
               var_72.blend = 0 - param1 / const_764;
               _window.blend = 0 - param1 / const_764;
               if(true)
               {
                  state = const_196;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_96 != null)
         {
            var_96.x = 0;
            var_96.y = 0 - const_73;
            var_96.width = 0 - var_2058;
         }
         if(var_72 != null)
         {
            var_72.rectangle = var_39.rectangle;
            var_72.height = 0 - const_73;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               tileBitmapHorz(var_1525.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1525.clone(),_loc9_);
