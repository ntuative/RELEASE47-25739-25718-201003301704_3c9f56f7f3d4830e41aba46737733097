package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1630:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1624:String = "level";
      
      private var var_98:IItemListWindow;
      
      private const const_1626:String = "energy";
      
      private var var_1204:Map;
      
      private const const_1628:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1625:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1627:int = 158;
      
      private const const_1631:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_260:PetCommandTool;
      
      private const const_1629:uint = 11184810;
      
      private const const_1623:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_212 != null)
         {
            var_98 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_98 == null || var_212 == null || var_60 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_260 == null)
         {
            var_260 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1204.getValue(var_702) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_260.showWindow(true);
            var_260.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1624,param1.level,param1.levelMax);
         updateStateElement(const_1623,param1.experience,param1.experienceMax);
         updateStateElement(const_1626,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_702 = param1.id;
         var_1204.remove(param1.id);
         var_1204.add(param1.id,param1);
         if(var_260 && var_260.isVisible() && param1.isOwnPet)
         {
            var_260.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_260.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1627,const_1631,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1629);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1625);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1630);
         return _loc5_;
      }
