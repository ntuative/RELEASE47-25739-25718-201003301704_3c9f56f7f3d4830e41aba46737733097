package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_598,onChooserContent);
      ...
      {
         if(var_495 == null || !var_495.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_495 == null)
         {
            var_495 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_495.populate(param1.items,param1.isAnyRoomController);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_598,onChooserContent);
