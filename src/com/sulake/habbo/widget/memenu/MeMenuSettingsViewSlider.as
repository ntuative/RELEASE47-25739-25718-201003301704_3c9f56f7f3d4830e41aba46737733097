package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_908:MeMenuSettingsView;
      
      private var var_2383:int;
      
      private var var_608:BitmapData;
      
      private var var_1074:Number = 1;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_908.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && var_607 != null)
         {
            _loc2_.bitmap = new BitmapData(var_607.width,var_607.height,true,16777215);
            _loc2_.bitmap.copyPixels(var_607,var_607.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_608 != null)
            {
               ...
               var_1585 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_607 = BitmapData(_loc2_.content);
      ...
      {
         return int(var_1585 * (Number(param1 - var_738) / (var_1074 - var_738)));
      }
      ...
      {
         return param1 / var_1585 * (var_1074 - var_738) + var_738;
      }
   }
}
