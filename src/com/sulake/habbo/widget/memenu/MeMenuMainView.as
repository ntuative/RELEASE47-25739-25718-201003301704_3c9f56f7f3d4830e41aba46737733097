      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_939);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_915));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_509);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_275);
               break;
            case "hc":
