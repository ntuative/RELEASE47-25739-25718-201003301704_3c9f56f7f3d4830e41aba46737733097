package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_637:MeMenuSettingsViewSlider;
      
      private var var_1400:BitmapData;
      
      private var var_1402:BitmapData;
      
      private var var_638:Number = 1;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_692);
         }
      ...
      {
         var_638 = param1.volume;
         if(var_637 != null)
         {
            var_637.setValue(var_638);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_637 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_536));
      }
