package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_710[var_1041] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_313)
         {
            ...
            var_313 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_313.center();
            var_313.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1041;
         if(var_1041 < var_710.length)
         {
            _loc1_ = var_710[var_1041] as Dictionary;
            if(!_loc1_)
            {
