package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1029,const_1028,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_183 != null)
         {
            _loc6_.caption = var_183;
         }
