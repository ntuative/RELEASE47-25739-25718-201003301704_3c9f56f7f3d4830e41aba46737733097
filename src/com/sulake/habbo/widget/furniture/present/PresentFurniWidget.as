package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_576,var_146);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1029,const_1028,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_183 != null)
         {
            _loc4_.caption = var_183;
         }
