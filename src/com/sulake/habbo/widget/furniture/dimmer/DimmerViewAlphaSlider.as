package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_90 && param1.type != WindowMouseEvent.const_449)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1585 * (var_1074 - var_738)) + var_738;
      }
   }
}
