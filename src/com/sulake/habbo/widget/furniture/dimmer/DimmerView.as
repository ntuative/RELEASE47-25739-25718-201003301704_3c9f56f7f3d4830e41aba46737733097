package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1029,const_1028,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         var_413 = colors.indexOf(_loc2_.color);
         if(var_476 != null)
         {
            var_476.setSelectedColorIndex(var_413);
         }
