package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1420:int = 60000;
      ...
      private var var_784:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_71.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_360)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_71.getParts(param1,(var_784 as AvatarImage).getFigure(),_loc6_,var_1279,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_71.getCanvas(var_197,var_1279);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1392[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_869 || _loc32_ == AvatarAction.const_634) && (_loc6_ == AvatarBodyPartType.const_302 || _loc6_ == AvatarBodyPartType.const_1360 || _loc6_ == AvatarBodyPartType.const_1184) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_197 == AvatarScaleType.const_53)
            {
               _loc30_.x += 67;
            }
            else
