package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1921 = parseInt(param1.@precedence);
         var_1918 = String(param1.@activepartset);
         var_1919 = String(param1.@assetpartdefinition);
         var_1923 = String(param1.@lay);
         var_1279 = String(param1.@geometrytype);
         var_1920 = Boolean(parseInt(param1.@main));
         var_1916 = Boolean(parseInt(param1.@var_2058));
         var_1922 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1203 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_582.add(param1,new Map());
         }
         var _loc4_:Map = var_582.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_582.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1203.concat(getTypePrevents(param1));
      }
