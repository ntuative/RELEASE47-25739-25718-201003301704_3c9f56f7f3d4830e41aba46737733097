package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_400:PartSetsData;
      
      private var var_1883:PartOffsetData;
      
      private var var_820:AvatarActionManager;
      
      private var var_167:IAssetLibrary;
      
      private var var_1005:IAssetLibrary;
      
      private var var_1385:Boolean = false;
      
      private var var_1882:AvatarRenderManager;
      
      private var var_399:FigureData;
      ...
      private var var_1476:AvatarStructureDownloadSet;
      
      private var var_674:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_167 = param2;
         var_1005 = param3;
         var_399 = new FigureData();
         var_400 = new PartSetsData();
         _animationData = new AnimationData();
         var_1476 = new AvatarStructureDownloadSet();
         var_674 = new AnimationManager();
         var_673 = param4;
         var_1883 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_820.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_673)
         {
            case AvatarType.const_81:
               _loc1_ = var_167.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_400.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_167.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_167.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_399.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_167.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_400.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_167.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_167.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_399.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_820.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_399.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_820.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_674.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               _loc2_ = _loc7_.method_9(0);
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_400.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_400.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1170[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_820.getDefaultActionType();
         var _loc9_:Array = var_400.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_674.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               for each(_loc20_ in _loc10_.method_9(0))
               {
                  if(_loc20_ == param1)
                  {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_399.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_399.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_400.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_400.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_81:
               if(var_167.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_167.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_167.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_167.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_673 + " ready to go!");
         if(var_673 == AvatarType.const_81)
         {
            var_400.getPartDefinition("ri").appendToFigure = true;
            var_400.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_81:
               if(var_167.hasAsset(_loc5_))
               {
                  var_167.removeAsset(var_167.getAssetByName(_loc5_));
               }
               var_1476.add(new AvatarStructureDownload(var_167,_loc5_,var_399));
               break;
            case AvatarType.PET:
         }
         var_1476.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_674.getAnimation(param1);
      }
      ...
      {
         var_820 = new AvatarActionManager(var_167,var_673);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_1005.hasAsset("dance" + _loc1_))
         {
            ...
            var_674.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_399.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_399.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_820.sortActions(param1);
      }
   }
}
