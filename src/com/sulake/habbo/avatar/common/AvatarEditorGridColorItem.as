package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_714:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_670 = _loc4_.content as BitmapData;
         ...
         var_713 = _loc6_.content as BitmapData;
         ...
         var_1047 = _loc8_.content as BitmapData;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_670.width,var_670.height,true,0);
            _loc1_.bitmap.copyPixels(var_670,var_670.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = var_879.clone();
            _loc4_.colorTransform(_loc4_.rect,var_714.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_713.width,var_713.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_713,var_713.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc5_.bitmap.copyPixels(var_1047,var_1047.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
