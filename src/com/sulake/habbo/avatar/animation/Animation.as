package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1545:DirectionDataContainer;
      
      private var var_1544:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               var_1287.push(new SpriteDataContainer(this as IAnimation,_loc5_));
            }
         }
         ...
         if(param2.hasOwnProperty("canvas"))
         {
            ...
            {
               var_1288.push(new CanvasDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            var_1545 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            var_1544 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc7_ in param2.remove)
            {
               var_1289.push(String(_loc7_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               var_718.push(new AddDataContainer(_loc8_));
            }
         }
         var _loc3_:int = 0;
      ...
      {
         return var_1545 != null;
      }
      
      public function hasSpriteData() : Boolean
      {
         return var_1287 != null;
      }
      ...
      public function method_9(param1:int) : Array
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
