package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1032:UserDataManager;
      ...
      public function start() : Boolean
      {
         ...
         {
            var_35 = RoomSessionEvent.const_91;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1032 as IUserDataManager;
      }
