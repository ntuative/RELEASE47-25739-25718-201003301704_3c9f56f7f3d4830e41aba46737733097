package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_582:String = "InitConnection";
      ...
      private var var_363:HabboCommunicationDemo;
      ...
      {
         var_363.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_363.shockwaveClientUrl = var_117.shockwaveClientUrl;
         var_363.ssoTicket = var_117.ticket;
         var_117.removeEventListener(SSOTicket.const_328,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_245,onParsedTicketFailure);
         var_117 = null;
         dispatchEvent(new Event(const_582));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1429,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_363 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_363.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_483,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_363.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1429,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_363.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_363.habboCommunication.habboWebLogin(name,password);
         var_117 = new SSOTicket(var_363.assets,_loc2_,_loc1_);
         var_117.addEventListener(SSOTicket.const_328,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_245,onParsedTicketFailure);
      }
