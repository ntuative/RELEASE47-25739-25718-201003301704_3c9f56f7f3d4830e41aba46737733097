package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2228:PseudoRandom;
      ...
      private const const_1429:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1145:
            case DisconnectReasonEvent.const_1310:
            ...
            case DisconnectReasonEvent.const_1344:
               ...
               break;
            case DisconnectReasonEvent.const_1274:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2226)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_747 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_747);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1352,var_2227));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1429,"/");
      ...
      private function onErrorReport(param1:IMessageEvent) : void
      {
         ...
         method_2("ERRORREPORT: Error code " + errorCode + " / Message id " + messageId);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2228);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1429,"/");
      ...
      {
         var_747 = _habboConfiguration.getKey("sso.ticket",null);
         var_1352 = _habboConfiguration.getKey("flash.client.url","");
         var_2227 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_747 != null)
         {
            var_66.mode = HabboConnectionType.const_384;
            var_66.initConnection(HabboConnectionType.const_272);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_66 = param2 as IHabboCommunicationManager;
            _loc3_ = var_66.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_66.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_66.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_66.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_66.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_66.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_66.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_66.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_66.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_66.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_66.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_66.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_66.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_66.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_613);
            _loc3_ = new InitCryptoMessageComposer(var_66.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2228 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_66.mode)
         {
            case HabboConnectionType.const_384:
               _loc6_ = "";
               ...
               var_1079 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1079,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_885:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1337:
               var_616 = generateRandomHexString(30);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1079);
         ...
         var _loc9_:IConnection = var_66.getHabboMainConnection(null);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_66.mode = HabboConnectionType.const_885;
            }
         }
         var_66.initConnection(HabboConnectionType.const_272);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         method_2("Authentication success!");
