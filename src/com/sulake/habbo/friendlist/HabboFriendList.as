package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1435:OpenedToWebPopup;
      
      private var var_802:IAvatarRenderManager;
      ...
      private var var_1436:AvatarSearchResults;
      ...
      private var var_800:IHabboNotifications;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1436 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_429.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_15.addCategory(new FriendCategory(FriendCategory.const_807,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_465,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_463)
         {
            var_463 = new Timer(120000);
            var_463.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_463.start();
         }
         getBuddyRequests();
         registerListeners();
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_463.stop();
            var_463.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_463 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_802)
         {
            var_802.release(new IIDAvatarRenderManager());
            var_802 = null;
         }
         if(var_800)
         {
            var_800.release(new IIDHabboNotifications());
            var_800 = null;
         }
         if(var_198)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_299));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1436.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.FRIENDLIST);
      ...
      {
         var _loc2_:FriendListTab = var_429.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_802.createAvatarImage(param1,AvatarScaleType.const_104);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_429.findTab(FriendListTab.const_85);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_802 = param2 as IAvatarRenderManager;
      ...
      {
         var_800 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1435 == null)
         {
            var_1435 = new OpenedToWebPopup(this);
         }
         var_1435.show(x,y);
      }
