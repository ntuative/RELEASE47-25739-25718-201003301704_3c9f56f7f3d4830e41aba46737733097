package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_316:int = 100;
      ...
      {
         return Math.ceil(this.var_222.length / const_316);
      }
      ...
      {
         if(this.var_824 >= this.getPageCount())
         {
            this.var_824 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_824 + 1) * const_316,this.var_222.length);
      }
