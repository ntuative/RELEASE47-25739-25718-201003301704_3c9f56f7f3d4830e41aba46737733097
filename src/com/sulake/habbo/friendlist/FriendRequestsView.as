package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_313 && _loc4_.state != FriendRequest.const_324)
            {
      ...
      {
         var_1505 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1506 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1506.procedure = onDismissAllButtonClick;
         var_1505.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_313 && _loc4_.state != FriendRequest.const_324)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_269,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1014)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_269,param1));
         }
      }
   }
}
