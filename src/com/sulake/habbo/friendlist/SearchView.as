package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_733 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_733.procedure = onSearchInput;
         var_733.addEventListener(WindowKeyboardEvent.const_153,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_49.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_288,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_733.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
