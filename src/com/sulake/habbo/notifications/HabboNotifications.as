package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1067:String = "badges";
      
      private static const const_1066:String = "pet_inventory";
      
      private static const const_1065:String = "pixelbalance";
      
      private static const const_1071:String = "credits";
      
      private static const const_1070:String = "inventory";
      
      private static const const_1069:String = "friendlist";
      
      private static const const_1068:String = "selectfurni";
      ...
      private var var_559:ParkBusDialogManager;
      
      private var var_558:IHabboToolbar;
      ...
      private var var_668:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_813);
         }
         var _loc6_:Map = var_813["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_668 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_826)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1249);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_82:
               ...
               break;
            case CatalogPageMessageProductData.include:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1160);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1830)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_958);
            var_1830 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_558)
         {
            var_558.release(new IIDHabboToolbar());
            var_558 = null;
         }
         if(_windowManager)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1066:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_144);
               }
               break;
            case const_1068:
               break;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_958,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_560.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_922,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_170 || param2.type == WindowEvent.const_571)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_559 == null)
         {
            var_559 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_559 != null)
         {
            var_559.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_986.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_560.createPetImage(_loc2_.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_340);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc15_ = var_340.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_82)
               {
                  _loc15_ = var_340.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_340.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1299,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_560.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      {
         var_558 = IHabboToolbar(param2);
         var_558.events.addEventListener(HabboToolbarEvent.const_88,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_340.userId == _loc2_.userId)
         {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_88)
         {
            ...
            var_391 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_813["styles"],var_813["view"],var_558);
            ...
            var_340.events.addEventListener(BadgeImageReadyEvent.const_130,onBadgeImage);
            var_558.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
