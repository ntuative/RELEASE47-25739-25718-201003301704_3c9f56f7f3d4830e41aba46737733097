package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_802,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_179,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_180,onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_629,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_852,onHideWindowEvent);
         var_35 = true;
