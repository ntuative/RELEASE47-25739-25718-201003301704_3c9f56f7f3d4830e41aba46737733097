package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1086:Number = 90;
      
      private static const const_766:int = 50;
      
      private static const const_1085:Number = 25;
      
      private static const const_1098:int = 50;
      
      private static const const_185:Boolean = true;
       
      
      private var var_586:Timer;
      
      private var var_1039:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_504.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_504.splice(_loc3_,1);
            var_503.splice(_loc3_,1);
         }
         var_503.push(param1.name);
         var_504.push(param2);
         param1.addEventListener(WindowEvent.const_396,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1039.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1039.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_587[_loc3_] = new Array();
            }
            if(var_587[_loc3_].indexOf(param1) < 0)
            {
               var_587[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_766 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_766 || param1.desktop.height - param1.y < const_1098;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_503[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_587[_loc3_].length)
                  {
                     repositionWindow(var_587[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
