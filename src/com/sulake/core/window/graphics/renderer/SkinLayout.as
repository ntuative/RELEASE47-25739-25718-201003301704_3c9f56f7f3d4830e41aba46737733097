package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_939:IChildEntityArray;
      ...
      public function getDefaultRegion(param1:String, param2:Rectangle) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = var_939.getChildByName(param1) as ISkinLayoutEntity;
            if(_loc3_ == null)
            {
      ...
      public function dispose() : void
      {
         ...
         for(_loc3_ in var_939)
         {
            ISkinLayoutEntity(var_939[_loc3_]).dispose();
            delete var_939[_loc3_];
         }
      }
