package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_365)
         {
            var_365 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_365)
            {
               var_365.addEventListener(WindowEvent.const_233,scrollBarEventProc);
               var_365.addEventListener(WindowEvent.const_199,scrollBarEventProc);
            }
         }
         return var_365;
      }
      ...
      override public function dispose() : void
      {
         if(var_365)
         {
            var_365.removeEventListener(WindowEvent.const_233,scrollBarEventProc);
            var_365.removeEventListener(WindowEvent.const_199,scrollBarEventProc);
            var_365 = null;
         }
         if(var_920)
         {
