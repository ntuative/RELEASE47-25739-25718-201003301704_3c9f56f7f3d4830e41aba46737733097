package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1092:String = "content";
      
      private static const const_1091:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1602 == null)
         {
            var_1602 = findChildByTag(TabContextController.const_1092) as IWindowContainer;
         }
         return var_1602;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_932 == null)
         {
            var_932 = findChildByTag(TabContextController.const_1091) as ITabSelectorWindow;
            if(var_932 != null)
            {
      ...
      {
         return !!var_818 ? selector.iterator : null;
      }
