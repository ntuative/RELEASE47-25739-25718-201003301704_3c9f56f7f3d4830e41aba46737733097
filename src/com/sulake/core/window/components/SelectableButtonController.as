package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
            ...
            if(var_8)
            {
               if(!(var_8 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_205,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_372,this,null);
         update(this,_loc1_);
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_572;
         update(this,_loc1_);
         return true;
      }
   }
