package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1131:String = "_HEADER";
      
      private static const const_783:String = "margin_right";
      
      private static const const_1132:String = "_SCALER";
      
      private static const const_1075:String = "_TITLE";
      
      private static const const_1133:String = "_CONTENT";
      
      private static const const_785:String = "margin_left";
      
      private static const const_784:String = "margin_bottom";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_785,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_786,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_783,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_784,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1362 == null)
         {
            var_1362 = findChildByTag(const_1131) as IHeaderWindow;
            if(!var_1362)
            {
      ...
      {
         return findChildByTag(const_1132) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_273,false);
         }
      ...
      {
         return content != null && var_1385 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_21 == null)
         {
            var_21 = findChildByTag(const_1133) as IWindowContainer;
            if(!var_21)
            {
