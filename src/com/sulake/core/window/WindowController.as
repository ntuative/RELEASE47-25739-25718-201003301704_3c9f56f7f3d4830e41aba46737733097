package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_624:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(param7 != null)
         {
            ...
            if(var_17)
            {
               _context.invalidate(this,var_7,WindowRedrawFlag.const_72);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_152);
         var _loc2_:* = !testParamFlag(WindowParam.const_113,WindowParam.const_135);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_753 = param1;
         var_621 = !!var_753 ? uint(var_621 | var_1379) : uint(var_621 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2085 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_985:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_604:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_565:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_205:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_668,var_7);
      ...
      {
         var_415 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_7,WindowRedrawFlag.const_1004);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1044 || _loc3_.hasGraphicsContext())
         {
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_621 = !!var_753 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_7,WindowRedrawFlag.const_72);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_961;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_208:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_366,this,null));
                     if(testParamFlag(WindowParam.const_168,WindowParam.const_152))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_178,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        ...
                        var_16 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_250,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_462:
                  _context.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_364);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_814,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_286:
                  if(param1 == this)
                  {
                     ...
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_205,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_409:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_965);
                  break;
               case WindowNotifyEvent.const_413:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_447:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_364);
                     }
                  }
                  else if(var_16 & 0)
                  {
               ...
               case WindowNotifyEvent.const_205:
                  ...
                  break;
               case WindowNotifyEvent.const_366:
                  var_8.getRegionProperties(null,var_315);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_307:
      ...
      {
         return var_624 != null ? var_624 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_286;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_604;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1044 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_876,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_501,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_64,true);
         _loc1_.type = WindowNotifyEvent.const_1367;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_315 = var_8.rectangle.clone();
               var_55.x = var_7.x;
               var_55.y = var_7.y;
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_367,this,var_8));
            }
            else
            {
               var_315.x = 0;
               ...
               var_315.width = 0;
               var_315.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_833,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_16 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_447,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_16,_context,var_7,null,var_624,properties,var_622.concat(),_id) as WindowController;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_683;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_35 == WindowState.const_480)
         {
            return true;
         }
