package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1004:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_567:uint = 0;
      
      public static const const_1005:String = "AssetLibraryReady";
      
      public static const const_1218:String = "AssetLibraryUnloaded";
      
      public static const const_406:String = "AssetLibraryLoaded";
      
      public static const const_1181:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_397 = new Dictionary(false);
         var_672 = new Dictionary(false);
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_397)
         {
            _loc2_ = var_397[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_397[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_672)
         {
            delete var_672[_loc1_];
         }
         if(var_18 != null)
         {
            var_18.dispose();
         ...
         var_302 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1218));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_344 = _loc2_.resource;
         if(var_482)
         {
            AssetLibrary.fetchLibraryContents(this,var_483,var_344);
         }
         var_302 = true;
         dispatchEvent(new Event(AssetLibrary.const_406));
         dispatchEvent(new Event(AssetLibrary.const_1005));
         if(var_482)
         {
            var_18.dispose();
            var_18 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_397[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_994,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1004.splice(var_1004.indexOf(this),1);
            --var_567;
            var_397 = null;
            var_672 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_343.length ? getAssetByName(var_343[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1181));
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_344[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_397[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_343.splice(var_343.indexOf(_loc2_),1);
      ...
      {
         return var_344 != null ? false : false;
      }
   }
}
