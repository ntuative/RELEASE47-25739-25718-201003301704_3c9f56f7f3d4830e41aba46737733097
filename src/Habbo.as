package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_21:String = "error_cat";
      ...
      public static const const_17:String = "error_data";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_21] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_17] = String(param3.getStackTrace());
            }
